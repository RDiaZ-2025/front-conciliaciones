...
export class NocIngresosService {
  ...
  async getIngresosGrafico(limite = 2000) {
    this.ensureDatabase();
  ...
  async getIngresosRedes(plataforma: string, limite = 200) {
    this.ensureDatabase();
...
export const nocIngresosService = new NocIngresosService();
