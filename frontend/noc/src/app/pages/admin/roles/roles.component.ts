...
@Component({
  selector: 'app-roles',
  standalone: true,
  imports: [CommonModule, FormsModule, PageHeaderComponent, ButtonModule, AvatarModule,
    LucideIconComponent],
  templateUrl: './roles.component.html', // Asegúrate que coincida con tu archivo real
