...
class AzureStorageService {
  ...
  constructor(config: AzureConfig = AZURE_CONFIG) {
    this.blobServiceClient = new BlobServiceClient(
      `https://${config.storageAccountName}.blob.core.windows.net/?${config.sasToken}`
    );
  ...
  /**
   * Generate folder path for document loading
   */
