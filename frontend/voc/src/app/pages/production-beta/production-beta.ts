...
import { ProductionRequest } from '../production_2/production.models';
import { ProductionDialogComponent } from '../production_2/components/production-dialog/production-dialog';
import { ProductionDetailDialogComponent } from '../production_2/components/production-detail-dialog/production-detail-dialog';
import { StageTransitionUploadDialogComponent } from '../production_2/components/stage-transition-upload-dialog/stage-transition-upload-dialog.component';
import { AnsDialogComponent } from '../production_2/components/ans-dialog/ans-dialog';
import { HistoryDialog } from '../production_2/components/history-dialog/history-dialog';
import { AzureStorageService } from '../../services/azure-storage.service';
import { FilePreviewComponent } from '../../components/file-preview/file-preview';
import { UploadedFile } from '../production_2/production.models';
import { InSellActionDialogComponent } from '../production_2/components/in-sell-action-dialog/in-sell-action-dialog.component';
import { UploadDialogComponent } from '../production_2/components/upload-dialog/upload-dialog.component';
import { ConsecutiveDialogComponent } from '../production_2/components/consecutive-dialog/consecutive-dialog.component';
import { AssignImplementationDialogComponent } from '../production_2/components/assign-implementation-dialog/assign-implementation-dialog.component';
import { MaterialRegisterListDialogComponent } from '../production_2/components/material-register-list-dialog/material-register-list-dialog.component';
...
@Component({
  ...
  templateUrl: './production-beta.html',
  styleUrl: './production-beta.scss'
})
